...
# ex: docker run acouvreur/sablier:1.0.01.0.0-beta.11.3.0-beta.3 --help
```
...
docker run -d -p 10000:10000 \
    -v $PWD/sablier.yml:/etc/sablier/sablier.yml acouvreur/sablier:1.0.01.0.0-beta.11.3.0-beta.3
```
